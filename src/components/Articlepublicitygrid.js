          ...
          {data.map((d, i) => (
            <Card className="border-0">
              ...
              <Card.Body className="p-0 ps-1 ">
                ...
                <Card.Title className="mt-1 mb-0">{d.title}</Card.Title>
                <Button className="py-1 px-2 btn-color " onClick={() => add(d)}>
                  <FontAwesomeIcon
                ...
                <Card.Text className="mt-1 mb-0">{d.description}</Card.Text>
              </Card.Body>
